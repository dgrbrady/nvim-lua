...
local function lsp_keymaps(bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>f", "<cmd>Telescope lsp_code_actions<CR>", opts)
  ...
  vim.cmd([[
    autocmd CursorHold <buffer> lua require('user.lsp.handlers').show_line_diagnostics()
  ]])
end
